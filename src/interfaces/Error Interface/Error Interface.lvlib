...
<Library LVVersion="20008000">
	...
	<Item Name="messages" Type="Folder">
		<Item Name="process error Msg.lvclass" Type="LVClass" URL="../../Error Interface Messages/process error Msg/process error Msg.lvclass"/>
	</Item>
	<Item Name="Error Interface.lvclass" Type="LVClass" URL="../Error Interface.lvclass"/>
